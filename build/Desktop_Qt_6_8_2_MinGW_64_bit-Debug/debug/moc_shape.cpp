...
static constexpr auto qt_meta_stringdata_ZN5ShapeE = QtMocHelpers::stringData(
    "Shape"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5ShapeE[] = {
...
Q_CONSTINIT const QMetaObject Shape::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5ShapeE.offsetsAndSizes,
    qt_meta_data_ZN5ShapeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5ShapeE_t,
        // Q_OBJECT / Q_GADGET
...
void *Shape::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5ShapeE.stringdata0))
